...
- Correction d’un pointage erroné.
- Rapport PDF détaillé et résumé mensuel.
- Calcul des jours et heures travaillés ainsi que des jours et heures d’absence sur une base de 7 heures par jour.
...
Le PDF contient pour chaque employé :

- toutes les dates de la période ;
- heure d’arrivée et heure de départ ;
- statut Présent, Absent, Week-end ou Jour férié ;
- total des jours travaillés ;
- total des heures travaillées lorsque l’arrivée et le départ existent ;
- total des jours d’absence ;
- total des heures d’absence, avec 7 heures par jour absent ;
- totaux des congés, week-ends et jours fériés.

Les congés, jours fériés, vendredis et samedis sont exclus du calcul des absences.
