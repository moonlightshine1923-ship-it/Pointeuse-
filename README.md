...
- **Rappels sonores** : une sonnerie et un message vocal retentissent sur le PC 5 minutes avant chaque moment clé — 8 h 25 (arrivée), 11 h 55 (pause), 12 h 55 (reprise) et 16 h 25 (départ) — du lundi au jeudi. Un bouton 🔔 sous l’horloge permet de couper le son sur ce PC.

### Dans l’administration

- Menu latéral à gauche avec accès direct à chaque rubrique.
- Tableau quotidien avec nom et prénom, arrivée, pause, reprise, départ et colonne d’avance / retard colorée.
...
- **Rappels sonores** : modification des heures d’arrivée, de pause, de reprise et de départ, du délai d’avance (5 minutes par défaut), activation globale et option « ne pas sonner les jours fériés ». Aucune sonnerie le vendredi et le samedi. Un bouton « Tester le son » permet de vérifier la sonnerie sur le PC serveur.
...
- Rapport PDF mensuel détaillé avec arrivée, pause, reprise, sortie et colonne d’avance / retard colorée, plus une ligne de total par employé.
...
5. Reprise ;
6. Heure de sortie ;
7. Avance / retard sur l’heure d’arrivée prévue (`+` en vert, `-` en rouge).
